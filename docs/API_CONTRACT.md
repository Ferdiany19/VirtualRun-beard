...
- `POST /api/admin/bib-templates/:templateVersionId/publish`
  menerima `csrfToken`, `eventId`, dan konfigurasi `settings` BIB lengkap; publish dapat
  memindahkan template ke event tujuan sekaligus menyimpan konfigurasi dan mengaktifkannya
  sebagai template BIB event tersebut.
