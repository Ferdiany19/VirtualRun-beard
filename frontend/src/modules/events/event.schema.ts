...
export const eventInputSchema = z.object({
  ...
  participantBenefits: z.array(eventParticipantBenefitSchema).max(12).default([]),
...
export function parseEventFormData(formData: FormData) {
  ...
  const participantBenefitsJson = String(formData.get("participantBenefitsJson") ?? "[]");
  ...
  return eventInputSchema.parse({
    ...
    registrationInstructions: String(formData.get("registrationInstructions") ?? ""),
    ...
    registrationEndsAt: parseJakartaDateTimeLocal(String(formData.get("registrationEndsAt") ?? "")),
    activityStartsAt: parseJakartaDateTimeLocal(String(formData.get("activityStartsAt") ?? "")),
    activityEndsAt: parseJakartaDateTimeLocal(String(formData.get("activityEndsAt") ?? "")),
    uploadStartsAt: parseJakartaDateTimeLocal(String(formData.get("uploadStartsAt") ?? "")),
    uploadEndsAt: parseJakartaDateTimeLocal(String(formData.get("uploadEndsAt") ?? "")),
