    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          requiresEvent: true,
          requiresEventManagement: true,
          match: (pathname) => pathname.includes("/participants"),
        },
        {
    ...
    >
      ...
      {collapsed ? null : (
        <footer className="mt-auto border-t border-white/10 pt-4 text-xs leading-5 text-white/55">
          <p className="font-bold text-white/80">Virtual Run Beard Admin v1.0.0</p>
          <p className="mt-2">&copy; 2026 Virtual Run Beard.</p>
